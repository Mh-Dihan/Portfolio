            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                        ...
                        <a href="Projects/Muhaiminul_Hasan_Dihan%27s_CV.pdf" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">
                            Download CV
                        </a>
                    ...
                    <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-muted-foreground">Full-Stack Web Developer with experience building scalable apps like ShopMate
                                    (e-commerce with React & Flask), Inventory Hub (inventory management with React + Vite), and an Event Scheduler
                                    platform. Skilled in creating responsive UIs, secure backends, and efficient, user-focused web solutions.
                                </p>
                            </div>
                        </div>
                    </div>
